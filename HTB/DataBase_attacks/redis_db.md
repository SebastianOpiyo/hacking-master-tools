...
KEYS *        # find all keys
AUTH password # used if password authentication is enabled
CLIENT LIST    # shows active connections
SELECT <database name/index>    # sets current database
FLUSHALL       # to delete all keys from all databases.
FLUSHDB        # to delete all keys from currently selected DB.
